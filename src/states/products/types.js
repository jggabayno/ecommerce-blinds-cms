...
export const ADD_PRODUCT_INFO_LOADING = 'ADD_PRODUCT_INFO_LOADING'
export const ADD_PRODUCT_INFO_SUCCESS = 'ADD_PRODUCT_INFO_SUCCESS'
export const ADD_PRODUCT_INFO_FAILURE = 'ADD_PRODUCT_INFO_FAILURE'

export const UPDATE_PRODUCT_INFO_LOADING = 'UPDATE_PRODUCT_INFO_LOADING'
...
export const DELETE_PRODUCT_INFO_LOADING = 'DELETE_PRODUCT_INFO_LOADING'
